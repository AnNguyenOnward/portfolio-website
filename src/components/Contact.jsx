...
const Contact = () => {
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "annguyenonward@jsmastery.pro",
  ...
  return (
    <div
      className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden border-4 border-light-cyan rounded-xl`}
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-dark-cyan py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary'
          >
